    ...
    public class GroupVisualiser
    {
        ...
        public GroupVisualiser(PointCloud pc)
        {
            ...
            for (int i = 0; i < depthFramePoints.Length; i++)
            {
                ...
                //stick point in depthframe points
                //this.depthFramePoints[i] = prgbs[i].point;

                //stick in surface normal
                //this.normals.Add(CalculateNormal(depthFramePoints[1], depthFramePoints[2], depthFramePoints[3]));

                //stick in triangle indices
        ...
        public MeshGeometry3D createMesh()
        {
            ...
            Console.WriteLine(this.depthFramePoints.Length);
            Console.WriteLine(this.textureCoordinates.Length);
            Console.WriteLine(this.triangleIndices.Count);
            Console.WriteLine(this.normals.Count);

            //return the mest that's encapsulated within this class 
            return this.mesh;
            /*
